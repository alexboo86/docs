...
<Note>
**Horizontal Line** is the only trend line tool that supports **price alerts**. When an alert is enabled, you can configure the condition (cross, price above, or price below) and the notification behavior (once or repeat). See the [Alerts](/indicators/alerts) page for full details.
</Note>
