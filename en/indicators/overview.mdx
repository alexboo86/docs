...
For full details on configuring and managing alerts, see the [Alerts](/en/advanced/alerts) documentation page.
...
| **Metrics** | ~8 | Derived market metrics: funding rate, open interest, enhanced liquidations |
...
- Learn how to set up [Alerts](/en/advanced/alerts) on supported indicators.
- Explore [Workspaces](/en/workspace/workspaces) to save and share your indicator configurations.
